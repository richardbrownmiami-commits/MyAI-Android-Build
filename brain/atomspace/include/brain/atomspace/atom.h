...
class Atom {
public:
    Atom(AtomId id, AtomType type, TruthValue truth = {});
...
public:
    Node(AtomId id, AtomType type, std::string name, TruthValue truth = {});
